...
gulp.task('sass', function() {
  return gulp.src('webapp/static/scss/*.scss')
    .pipe(sass())
...
gulp.task('watch', function() {
  gulp.watch('webapp/static/js/*.js', ['scripts']);
  gulp.watch('webapp/static/scss/*.scss', ['sass']);
  gulp.watch('webapp/static/css/*.css', ['css']);
});
